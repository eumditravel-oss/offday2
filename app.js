const checklistRows = [
  ...
  },
  {
    ...
    "trade": "프로젝트 유형",
    "no": "005",
    "item": "프로젝트 유형 파악 (입찰 / 본실행 / 구조선수행 등)",
    "method": "계약방식과 발주처 요청사항 기준으로 유형 분류",
    "owner": "PM",
    "targets": [
      "PM"
    ],
  ...
  },
  {
    ...
    "no": "008",
    "item": "토공사 산출유무 확인",
    "method": "토목팀 투입 유무 확인 및 건축디따기 산출 여부 협의",
    "owner": "PM",
    "targets": [
      "PM"
    ],
  ...
  },
  {
    ...
    "trade": "합벽",
    "no": "009",
    "item": "합벽유무 및 합벽구간 추가이음 발생 여부 확인",
  ...
  },
  {
    ...
    "trade": "도면목록표",
    "no": "019",
    "item": "도면목록표와 도서가 일치하는지 확인",
    "method": "PM과 산출 담당자 모두 도면 누락본 확인할 것",
    "owner": "PM, 산출 담당자",
    "targets": [
      "PM",
      "산출 담당자"
  ...
  },
  {
    ...
    "method": "정리 완료 후 내부 PM 및 외부 발주처 담당자에게 동시 발송",
    "owner": "산출 담당자",
    "targets": [
      "산출 담당자"
    ],
  ...
  },
  {
    ...
    "trade": "파일공사",
    "no": "007",
    "item": "파일길이 및 항타장비, 동재하 정재하 시험횟수 확인",
    "method": "지질조서도 확인",
    "owner": "산출 담당자",
    "targets": [
      "산출 담당자"
  ...
  },
  {
    ...
    "method": "발주처 및 건설사 질의사항 작성. Zoning 및 분할타설 계획도 요청",
    "owner": "산출 담당자",
    "targets": [
      "산출 담당자"
    ],
  ...
  },
  {
    ...
    "trade": "철근 규격 변경",
    "no": "020",
    "item": "데크 슬라브 구분이 필요하여 H-BAR → D-BAR 구분 필요",
  ...
  },
  {
    ...
    "no": "021",
    "item": "띠장구간 이음1회 추가",
    "method": "띠장 도면 참조하여 띠장이 걸리는 구간은 1회 이음을 추가 해 주세요",
    "owner": "PM",
    "targets": [
      "PM"
    ],
  ...
  },
  {
    ...
    "no": "011",
    "item": "커플러 산출기준 확인",
    "method": "건설사별 견적지침서 확인. 별도 표현 없을 시 담당자 확인",
    "owner": "산출 담당자",
    "targets": [
      "산출 담당자"
    ],
  ...
  },
  {
    ...
    "no": "013",
    "item": "내진철근 적용 유무 확인",
    "method": "SD400S, SD500S, SD600S 등의 표현 유무 확인",
    "owner": "산출 담당자",
    "targets": [
      "산출 담당자"
    ],
  ...
  },
  {
    ...
    "method": "산출식 확인 후 기초두께 입력 시 주근 이음 산출 여부 검토",
    "owner": "산출 담당자",
    "targets": [
      "산출 담당자"
    ],
  ...
  },
  {
    ...
    "no": "017",
    "item": "부호별 데크타입 오류 확인",
    "method": "RC 평면자료를 Excel 변환 후 필터로 데크부호별 코드입력 체크",
    "owner": "산출 담당자",
    "targets": [
      "산출 담당자"
    ],
  ...
  },
  {
    ...
    "trade": "보",
    "no": "022",
    "item": "B2G1 늑근 간격 150mm가 아닌 300mm로 잘못 산출 됨",
  ...
  },
  {
    ...
    "trade": "계수",
    "no": "023",
    "item": "유사 프로젝트 대비 콘크리트 계수 확인",
    "method": "비슷한 형태의 프로젝트를 찾아 콘크리트 계수가 비슷한지 확인 해 주세요",
    "owner": "PM, 산출 담당자",
    "targets": [
      "PM",
      "산출 담당자"
  ...
  },
  {
    ...
    "method": "비슷한 형식의 프로젝트를 찾아 거푸집 계수 확인을 해 주세요",
    "owner": "PM, 산출 담당자",
    "targets": [
      "PM",
      "산출 담당자"
  ...
  },
  {
    ...
    "method": "비슷한 유형의 프로젝트를 찾아서 계수 검토 해 주세요",
    "owner": "PM, 산출 담당자",
    "targets": [
      "PM",
      "산출 담당자"
